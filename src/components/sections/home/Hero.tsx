...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'intelligent accounting',
  description:
    'Automate bookkeeping, track expenses, and generate financial reports in real-time. Built specifically for small businesses who need professional accounting without the complexity.',
  features: [
  ...
  imageAlt: 'Accolade accounting dashboard',
