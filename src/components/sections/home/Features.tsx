...
const DEFAULT_FEATURES = {
  ...
  mainDescription:
    'Streamline your accounting operations with our comprehensive financial management solution designed specifically for small businesses and growing enterprises.',
  feature1Title: 'Automated Bookkeeping',
  feature1Description:
    'Automatically categorize transactions, reconcile bank accounts, and generate financial reports with AI-powered accuracy.',
  feature1Badge: 'Automation',
  feature2Title: 'Bank-Level Security',
  feature2Description:
    'SOC 2 compliant with 256-bit encryption, multi-factor authentication, and complete audit trails for peace of mind.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Accounting App',
  feature3Description:
    'Manage invoices, track expenses, and monitor cash flow on-the-go with our native mobile applications.',
  ...
  feature5Description:
    'Generate P&L statements, balance sheets, cash flow reports, and custom analytics with real-time data.',
  feature5Badge: 'Reporting',
  feature6Title: 'Smart Tax Preparation',
  feature6Description:
    'Automated tax calculations, quarterly estimates, and seamless integration with popular tax software.',
  feature6Badge: 'Tax Ready',
  feature7Title: 'API & Integrations',
  feature7Description:
    'Connect with 200+ business tools including banks, payment processors, and e-commerce platforms.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert CPA Support',
  feature8Description:
    'Access to certified accountants and bookkeepers with unlimited consultations and setup assistance.',
  feature8Badge: 'Support',
  feature9Title: 'Data Protection & Backup',
  feature9Description:
    'Your financial data is encrypted, backed up in real-time, and stored in secure cloud infrastructure.',
